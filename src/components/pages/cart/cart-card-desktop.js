...
const CartCardDesktop = ({ item, addToCart, removeFromCart, updateQuantity, handleIncreaseQuantity, handleDecreaseQuantity }) => {
    return ( 
        <div className="border-l border-r border-b border-solid border-grey flex h-32">
            <div className="w-[5%] h-full border-r border-grey border-solid flex items-center px-4">
            ...
            <div className="w-[10%] h-full border-r border-grey border-solid flex items-center">
            <div className="border-2 border-solid border-grey rounded-xl overflow-hidden min-h-20 min-w-20 h-20 w-20 mx-auto">
                <Image 
            ...
            <div className="w-[30%] h-full border-r border-grey border-solid flex flex-col gap-2 justify-center px-4 font-primary text-text-title">
            <span>{item.name} </span>
            <span>
              {item.identifier && (() => {
            ...
            <div className="w-[15%] h-full border-r border-grey border-solid flex items-center px-4 font-primary text-text-title">
              £{parseFloat(item.price).toFixed(2)}
            </div>
            <div className="w-[18%] h-full border-r border-grey border-solid flex items-center px-4 font-primary text-text-title">
            ...
            <div className="w-[22%] h-full flex items-center px-4 font-primary text-text-title">
